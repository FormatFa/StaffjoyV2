...
load("@io_bazel_rules_go//go:deps.bzl", "go_host_sdk", "go_rules_dependencies","go_register_toolchains","go_download_sdk","go_local_sdk")
...
http_archive(
    ...
    urls = ["https://ghproxy.com/github.com/bazelbuild/rules_docker/releases/download/v%s/rules_docker-v%s.tar.gz" % (RULES_DOCKER_VERSION, RULES_DOCKER_VERSION),
    "https://kgithub.com/bazelbuild/rules_docker/releases/download/v%s/rules_docker-v%s.tar.gz" % (RULES_DOCKER_VERSION, RULES_DOCKER_VERSION)],
...
git_repository(
    ...
    remote = "https://kgithub.com/bazelbuild/rules_license.git",
...
# Required by IO_RULES_DOCKER_VERSION > 0.14.4 (https://kgithub.com/bazelbuild/rules_docker/issues/1550)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/dpapathanasiou/go-recaptcha.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/ttacon/libphonenumber.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/ttacon/builder.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/golang-jwt/jwt.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/gorilla/sessions.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/gorilla/securecookie.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/gorilla/csrf.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/gorilla/mux.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/pkg/errors.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/mailgun/mailgun-go.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/json-iterator/go.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/modern-go/reflect2.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/modern-go/concurrent.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/sirupsen/logrus.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/stretchr/testify.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/urfave/negroni.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/getsentry/raven-go.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/getsentry/sentry-go.git",
)
...
new_git_repository(
   ...
   remote = "https://kgithub.com/googleapis/gax-go.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/grpc/grpc-go.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/googleapis/go-genproto.git"
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/LandRover/grpc-gateway.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/gogo/protobuf.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/golang/glog.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/josharian/intern.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/golang/protobuf.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/protocolbuffers/protobuf-go.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/certifi/gocertifi.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/intercom/intercom-go.git"
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/google/go-querystring.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/google/go-cmp.git",
)
...
http_archive(
    ...
    urls = ["https://ghproxy.com/github.com/googleapis/google-api-go-client/archive/v%s.tar.gz" % GO_GOOGLE_API_VERSION],
...
http_archive(
    ...
    urls = ["https://ghproxy.com/github.com/GoogleCloudPlatform/google-cloud-go/archive/v%s.tar.gz" % GO_GOOGLE_CLOUD_VERSION],
...
new_git_repository(
    ...
    remote = "https://kgithub.com/golang/appengine.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/go-gorp/gorp.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/russross/blackfriday.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/shurcool/sanitized_anchor_name.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/fatih/structs.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/go-sql-driver/mysql.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/golang/net.git"
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/golang/oauth2.git"
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/golang/time.git"
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/golang/crypto.git"
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/golang/text.git"
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/golang/sync.git"
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/census-instrumentation/opencensus-go.git"
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/hashicorp/golang-lru.git"
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/GeertJohan/go.rice.git",
)
...
new_git_repository(
    ...
    remote = "https://kgithub.com/daaku/go.zipexe.git",
)
