...
do
    ...
    # Run the build and upload to GKE --toolchain_resolution_debug='@io_bazel_rules_go//go:toolchain'
    bazel run --platforms //linux:amd64 //${TARGET}:docker --platforms linux:amd64
